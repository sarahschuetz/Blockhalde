...
public class SimplePerlinTerrainGenerator implements TerrainGenerator{
    ...
    public void generate(TerrainChunk chunk, String seed) {
        PerlinNoise3D perlinNoise = new PerlinNoise3D(seed.hashCode());
                ...
                for(int z = 0; z < Chunk.Z_MAX; z++){
                   ...
                   // }else if(y >maximumHeight){
                     //   chunk.setBlock(x,y,z, BlockType.AIR);
                        ...
                        double noise = perlinNoise.calcPerlinAt((x+chunk.getChunkPosition().getXPosition())/(double)Chunk.X_MAX,y/(double)Chunk.Y_MAX,(z+chunk.getChunkPosition().getZPosition())/(double)Chunk.Z_MAX);
