...
public class World implements WorldInterface {
    ...
    /**
     * calculates the visible chunks based on the player position and the draw distance
     */
    ...
    public void setBlock(int x, int y, int z, BlockType blockType){
        ...
        if(chunk!=null){
            //TODO set up write permission interface for chunk, then replace the following line
